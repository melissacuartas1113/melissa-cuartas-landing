            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                ...
                >
                  ...
                  {social.label === 'TikTok' && (
                    <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24"><path d="M12 2c-5.523 0-10 4.477-10 10s4.477 10 10 10 10-4.477 10-10-4.477-10-10-10zm.5 15h-1v-6h1v6zm2-8h-1V7h1v2zm-4 0h-1V7h1v2z"/><path d="M12 2c-5.523 0-10 4.477-10 10s4.477 10 10 10 10-4.477 10-10-4.477-10-10-10zm3.5 8.5c0 .828-.672 1.5-1.5 1.5s-1.5-.672-1.5-1.5.672-1.5 1.5-1.5 1.5.672 1.5 1.5z"/></svg>
                  )}
