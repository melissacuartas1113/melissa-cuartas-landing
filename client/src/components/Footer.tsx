            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                ...
                >
                  ...
                  {social.label === 'TikTok' && (
                    <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24"><path d="M12.525.02C7.1.02 2.75 4.35 2.75 9.9c0 5.55 4.35 9.9 9.75 9.9s9.75-4.35 9.75-9.9c0-5.55-4.35-9.9-9.75-9.9zM9.96 17.12c-1.44 0-2.61-1.17-2.61-2.61 0-1.44 1.17-2.61 2.61-2.61 1.44 0 2.61 1.17 2.61 2.61 0 1.44-1.17 2.61-2.61 2.61zm4.08-4.26c-1.44 0-2.61-1.17-2.61-2.61 0-1.44 1.17-2.61 2.61-2.61 1.44 0 2.61 1.17 2.61 2.61 0 1.44-1.17 2.61-2.61 2.61z"/></svg>
                  )}
