              ...
              <div className="relative backdrop-blur-sm rounded-lg p-8 h-full transition-all duration-300" style={{ background: 'rgba(26, 40, 71, 0.5)', border: '1px solid rgba(196, 179, 232, 0.2)' }}>
                ...
                <div className="relative z-10 space-y-4 text-center">
                  ...
                  <div className="w-16 h-16 rounded-lg flex items-center justify-center mx-auto" style={{ background: 'linear-gradient(135deg, var(--color-purple), var(--color-teal))' }}>
                    ...
                    {social.name === 'TikTok' && (
                      <svg className="w-8 h-8" fill="white" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.1 1.82 2.89 2.89 0 0 1 5.1-1.82V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 5.26-3.09 6.33 6.33 0 0 0 6.33-6.33v-5.3c1.26.86 2.73 1.5 4.32 1.75v-3.4a4.82 4.82 0 0 1-3.32-1.04z"/></svg>
                    )}
                    {social.name === 'YouTube' && (
